...
df = pd.read_parquet('dataset/ALICE-OSLdataset/ALICE_info_no_severity_D_with_topic.parquet.gzip')
...
fig4 = topic_model.model.visualize_topics_per_class(topics_per_class)
